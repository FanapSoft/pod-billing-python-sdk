...
try:
    ...
    invoice_id = 123456
    if pod_billing.verify_invoice(invoice_id=invoice_id, sc_api_key=SC_API_KEY, sc_voucher_hash=SC_VOUCHER_HASH):
        print("Invoice verified")

    bill_number = "Py123456"
    if pod_billing.verify_invoice_by_bill_number(bill_number=bill_number, sc_api_key=SC_API_KEY,
